...
const Dashboard = () => {
  ...
  <div>
    <div className='max-w-7xl mx-auto px-4 py-8'>
      ...
      {showCreateResume && (
        <form onSubmit={createResume} onClick={(e) => e.stopPropagation()} className='fixed inset-0 bg-black/70 backdrop-blur bg-opacity-50 z-10 flex items-center justify-center'>
          <div onClick={(e)=>e.stopPropagation()} className='relative bg-slate-50 border shadow-md rounded-lg w-full max-w-sm p-6'>
            <h2 className='font-bold text-xl mb-4'>Create a Resume</h2>
      ...
      {showUploadResume && (
        <form onSubmit={uploadResume} onClick={(e) => e.stopPropagation()} className='fixed inset-0 bg-black/70 backdrop-blur bg-opacity-50 z-10 flex items-center justify-center'>
          <div onClick={(e)=>e.stopPropagation()} className='relative bg-slate-50 border shadow-md rounded-lg w-full max-w-sm p-6'>
      ...
      {editResumeId && (
        <form onSubmit={editTitle} onClick={(e) => e.stopPropagation()} className='fixed inset-0 bg-black/70 backdrop-blur bg-opacity-50 z-10 flex items-center justify-center'>
          <div onClick={(e)=>e.stopPropagation()} className='relative bg-slate-50 border shadow-md rounded-lg w-full max-w-sm p-6'>
            <h2 className='font-bold text-xl mb-4'>Edit Resume Title</h2>

            <input
              onChange={(e)=>setTitle(e.target.value)} value={title}
              type="text"
              placeholder='Update resume title'
              className='w-full px-4 py-2 mb-4 focus:border-green-600 ring-green-600'
              required
            />
